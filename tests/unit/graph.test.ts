...
import { reciprocalRankFusion, weightedScoreFusion, interleave } from '../../src/retrieval/fusion/rrf.js';
import { generateLineDiff, formatDiff, getDiffSummary } from '../../src/writeback/diff-generator.js';
...
describe('Reciprocal Rank Fusion', () => {
  ...
  it('should respect custom weights', () => {
    const resultLists = new Map([
      ['high_weight', [
        { id: 'a', score: 0.9, source: 'high_weight' },
      ]],
      ['low_weight', [
        { id: 'b', score: 0.9, source: 'low_weight' },
      ]],
    ]);
...
describe('Weighted Score Fusion', () => {
  it('should compute weighted average scores', () => {
    const resultLists = new Map([
      ['source1', [
        { id: 'a', score: 1.0, source: 'source1' },
      ]],
      ['source2', [
        { id: 'a', score: 0.5, source: 'source2' },
      ]],
    ]);
